...
public class Application_Fumian2_Proxy implements Application_PortType {
  private String _endpoint = null;
  private Application_PortType application_PortType = null;
  
  public Application_Fumian2_Proxy() {
    _initApplicationProxy();
  }
  
  public Application_Fumian2_Proxy(String endpoint) {
    _endpoint = endpoint;
    _initApplicationProxy();
  }
  ...
  private void _initApplicationProxy() {
    try {
      application_PortType = (new Application_Fumian2_Service()).getApplication();
