...
package com.smy.server.fumian2;
...
public class Application_Fumian2_PortType extends Stub implements Application_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("CreditScore_alphas_fumian2");
        ...
        oper.setReturnQName(new QName("tns", "CreditScore_alphas_fumian2Result"));
    ...
    public Application_Fumian2_PortType() throws AxisFault {
         this(null);
    }

    public Application_Fumian2_PortType(URL endpointURL, Service service) throws AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public Application_Fumian2_PortType(Service service) throws AxisFault {
        if (service == null) {
	...
	public Object modelScore(String cell, Object inputObj,Map<String, Object> params)
		...
		_call.setSOAPActionURI("CreditScore_alphas_fumian2");
		_call.setEncodingStyle(null);
		_call.setProperty(Call.SEND_TYPE_ATTR, Boolean.FALSE);
      	_call.setProperty(AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
      	_call.setSOAPVersion(SOAPConstants.SOAP11_CONSTANTS);
      	_call.setOperationName(new QName("tns", "CreditScore_alphas_fumian2"));
