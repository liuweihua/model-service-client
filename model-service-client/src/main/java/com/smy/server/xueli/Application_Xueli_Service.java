...
public class Application_Xueli_Service extends Service implements Application_Service {
    ...
    public Application_Xueli_Service(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public Application_Xueli_Service(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public Application_PortType getApplication(URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Application_Xueli_PortType _stub = new Application_Xueli_PortType(portAddress, this);
