...
public class Application_NoPyXueli_PortType extends Stub implements Application_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("CreditScore_alphas_xueli_npy");
        ...
        oper.setReturnQName(new QName("tns", "CreditScore_alphas_xueli_npyResult"));
    ...
    public Application_NoPyXueli_PortType() throws AxisFault {
         this(null);
    }

    public Application_NoPyXueli_PortType(URL endpointURL, Service service) throws AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public Application_NoPyXueli_PortType(Service service) throws AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
           ...
           // cachedSerFactories.add(new ArraySerializerFactory());
	...
	public Object modelScore(String cell, Object inputObj,Map<String, Object> params)
		...
		_call.setSOAPActionURI("CreditScore_alphas_xueli_npy");
		_call.setEncodingStyle(null);
		_call.setProperty(Call.SEND_TYPE_ATTR, Boolean.FALSE);
      	_call.setProperty(AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
      	_call.setSOAPVersion(SOAPConstants.SOAP11_CONSTANTS);
      	_call.setOperationName(new QName("tns", "CreditScore_alphas_xueli_npy"));

      	setRequestHeaders(_call);
      	setAttachments(_call);
		try {
			
			String inputX = (String) inputObj;
			
		 	Object _resp = _call.invoke(new Object[] {cell,inputX});
