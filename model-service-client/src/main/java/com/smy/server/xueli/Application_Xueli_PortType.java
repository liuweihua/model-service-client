...
public class Application_Xueli_PortType extends Stub implements Application_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("CreditScore_alphas_xueli_py");
        ...
        oper.setReturnQName(new QName("tns", "CreditScore_alphas_xueli_pyResult"));
    ...
    public Application_Xueli_PortType() throws AxisFault {
         this(null);
    }

    public Application_Xueli_PortType(URL endpointURL, Service service) throws AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public Application_Xueli_PortType(Service service) throws AxisFault {
        if (service == null) {
     ...
     */
	@Override
	public Object modelScore(String cell, Object inputX,Map<String, Object> params)
			throws RemoteException {
		if (super.cachedEndpoint == null) {
      ...
      _call.setSOAPActionURI("CreditScore_alphas_xueli_py");
      _call.setEncodingStyle(null);
      _call.setProperty(Call.SEND_TYPE_ATTR, Boolean.FALSE);
      _call.setProperty(AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
      _call.setSOAPVersion(SOAPConstants.SOAP11_CONSTANTS);
      _call.setOperationName(new QName("tns", "CreditScore_alphas_xueli_py"));
