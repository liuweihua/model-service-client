...
public class Application_AlphaS_Service extends Service implements Application_Service {
	...
	public Application_AlphaS_Service(String modelUrl) {
		this.application_address = modelUrl;
    }


    public Application_AlphaS_Service(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public Application_AlphaS_Service(String wsdlLoc, QName sName) throws ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public Application_PortType getApplication(URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Application_AlphaS_PortType _stub = new Application_AlphaS_PortType(portAddress, this);
    ...
    public Remote getPort(Class serviceEndpointInterface) throws ServiceException {
        try {
            if (Application_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                Application_AlphaS_PortType _stub = new Application_AlphaS_PortType(new URL(application_address), this);
                _stub.setPortName(getApplicationWSDDServiceName());
                return _stub;
            }
        }catch (Throwable t) {
