...
public class Application_AlphaS_PortType extends Stub implements Application_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("CreditScore_alphas");
        ...
        oper.setReturnQName(new QName("tns", "CreditScore_alphasResult"));
    ...
    public Application_AlphaS_PortType() throws AxisFault {
         this(null);
    }

    public Application_AlphaS_PortType(URL endpointURL, Service service) throws AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public Application_AlphaS_PortType(Service service) throws AxisFault {
        if (service == null) {
	...
	public Object modelScore(String cell, Object inputObj,Map<String, Object> params)
		...
		_call.setSOAPActionURI("CreditScore_alphas");
		_call.setEncodingStyle(null);
		_call.setProperty(Call.SEND_TYPE_ATTR, Boolean.FALSE);
		_call.setProperty(AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
		_call.setSOAPVersion(SOAPConstants.SOAP11_CONSTANTS);
		_call.setOperationName(new QName("tns", "CreditScore_alphas"));
