...
public class Application_Br_Service extends Service implements Application_Service {
	...
	public Application_Br_Service() {
    }


    public Application_Br_Service(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public Application_Br_Service(String wsdlLoc, QName sName) throws ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for Application
    HttpUrlConfig huc = HttpUrlConfig.getInstance();
    private String Application_address = huc.getBrUrl();
    ...
    public Application_PortType getApplication(URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Application_Br_PortType _stub = new Application_Br_PortType(portAddress, this);
    ...
    public Remote getPort(Class serviceEndpointInterface) throws ServiceException {
        try {
            if (Application_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                Application_Br_PortType _stub = new Application_Br_PortType(new URL(Application_address), this);
                _stub.setPortName(getApplicationWSDDServiceName());
                return _stub;
            }
        }catch (Throwable t) {
