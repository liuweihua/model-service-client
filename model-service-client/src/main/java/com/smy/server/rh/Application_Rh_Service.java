...
public class Application_Rh_Service extends Service implements Application_Service {
	...
	public Application_Rh_Service(String modelUrl) {
		this.application_address = modelUrl;
    }


    public Application_Rh_Service(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public Application_Rh_Service(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public Application_PortType getApplication(URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Application_Rh_PortType _stub = new Application_Rh_PortType(portAddress, this);
    ...
    public Remote getPort(Class serviceEndpointInterface) throws ServiceException {
        try {
            if (Application_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                Application_Rh_PortType _stub = new Application_Rh_PortType(new URL(application_address), this);
                _stub.setPortName(getApplicationWSDDServiceName());
                return _stub;
            }
        }catch (Throwable t) {
