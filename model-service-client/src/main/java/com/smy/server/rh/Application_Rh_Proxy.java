...
public class Application_Rh_Proxy implements Application_PortType {
  private String _endpoint = null;
  private Application_PortType application_PortType = null;
  
  public Application_Rh_Proxy() {
    _initApplicationProxy();
  }
  
  public Application_Rh_Proxy(String endpoint) {
    _endpoint = endpoint;
    _initApplicationProxy();
  }
  ...
  private void _initApplicationProxy() {
    try {
      application_PortType = (new Application_Rh_Service()).getApplication();
