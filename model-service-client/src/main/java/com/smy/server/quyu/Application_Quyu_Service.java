...
public class Application_Quyu_Service extends Service implements Application_Service {
    ...
    public Application_Quyu_Service(org.apache.axis.EngineConfiguration config) {
        super(config);
    }
    ...
    public Application_PortType getApplication(URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Application_Quyu_PortType _stub = new Application_Quyu_PortType(portAddress, this);
