package com.smy.server.srfuzhai;
...
public class Application_Srfuzhai_Service extends Service implements Application_Service {
	...
	public Application_Srfuzhai_Service(String modelUrl) {
		this.application_address = modelUrl;
    }


    public Application_Srfuzhai_Service(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public Application_Srfuzhai_Service(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public Application_PortType getApplication(URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Application_Srfuzhai_PortType _stub = new Application_Srfuzhai_PortType(portAddress, this);
    ...
    public Remote getPort(Class serviceEndpointInterface) throws ServiceException {
        try {
            if (Application_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                Application_Srfuzhai_PortType _stub = new Application_Srfuzhai_PortType(new URL(application_address), this);
                _stub.setPortName(getApplicationWSDDServiceName());
                return _stub;
            }
        }catch (Throwable t) {
