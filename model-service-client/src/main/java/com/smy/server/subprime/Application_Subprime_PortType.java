...
public class Application_Subprime_PortType extends Stub implements Application_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnQName(new QName("tns", "cddl_rcmdResult"));
    ...
    public Application_Subprime_PortType() throws AxisFault {
         this(null);
    }

    public Application_Subprime_PortType(URL endpointURL, Service service) throws AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public Application_Subprime_PortType(Service service) throws AxisFault {
        if (service == null) {
