...
public class Application_DNA3_Service extends Service implements Application_Service {
    ...
    public Application_DNA3_Service(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public Application_DNA3_Service(String wsdlLoc, QName sName) throws ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public Application_PortType getApplication(URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Application_DNA3_PortType _stub = new Application_DNA3_PortType(portAddress, this);
