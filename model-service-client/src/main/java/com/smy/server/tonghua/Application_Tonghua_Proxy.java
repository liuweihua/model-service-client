...
public class Application_Tonghua_Proxy implements Application_PortType {
  private String _endpoint = null;
  private Application_PortType application_PortType = null;
  
  public Application_Tonghua_Proxy() {
    _initApplicationProxy();
  }
  
  public Application_Tonghua_Proxy(String endpoint) {
    _endpoint = endpoint;
    _initApplicationProxy();
  }
  ...
  private void _initApplicationProxy() {
    try {
      application_PortType = (new Application_Tonghua_Service()).getApplication();
